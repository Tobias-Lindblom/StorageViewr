...
const schema = new Schema({
  ...
  warehouseId: { type: Schema.Types.ObjectId, required: true, immutable: true },
...
export const InventorySession: Model<InventorySessionRecord> =
  (models.InventorySession as Model<InventorySessionRecord> | undefined) ?? model<InventorySessionRecord>("InventorySession", schema);
