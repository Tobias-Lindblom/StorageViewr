  ...
  return (
    <OrganizationShell session={session}>
      <div className="mx-auto max-w-xl">
        <Link
          href="/organizations"
          className="mb-6 inline-flex min-h-13 items-center gap-2 text-sm text-cyan"
        >
        ...
        <p className="mb-7 text-sm leading-7 text-muted">
          Börja med namn och företagskod. Du blir administratör och kan sedan
          lägga till företagets lager och platser.
        </p>
