  ...
  return (
    <AppShell context={context}>
      ...
      <div className="mb-8 grid grid-cols-2 gap-3 sm:gap-5">
        {[
          { label: "Aktiva lager", value: dashboard.warehouseCount, href: "/warehouses", icon: "warehouse" as const },
          { label: "Aktiva lagerplatser", value: dashboard.locationCount, href: "/locations", icon: "location" as const },
        ].map(item => (
          <Link
            key={item.href}
            href={item.href}
      ...
      <section aria-labelledby="warehouses-heading" className="border-t border-line/60 pt-6">
